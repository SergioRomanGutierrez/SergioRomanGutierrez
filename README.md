...
## 🖥️ Infrastructure | Cloud | Cybersecurity

Building enterprise infrastructure labs while pursuing a long-term specialization in Cloud Computing, Networking and Cybersecurity.

🐧 Linux • 🪟 Windows Server • ☁️ Cloud • 🌐 Networking • 🔐 Cybersecurity • 🐳 Docker
...
ASIR
   ↓
Advanced Vocational Training in Cybersecurity
   ↓
Computer Engineering Degree
   ↓
Master's Degree in Cybersecurity
   ↓
Cloud, Networking & Security Specialization
```
...
with expertise across AWS, Microsoft Azure, Cisco Networking and Cybersecurity.
